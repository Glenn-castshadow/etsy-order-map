...
function makeTreasureIcon(weight) {
  ...
  const coins = Array.from({ length: layers }, (_, i) =>
    `<span style="position:absolute;bottom:${i * step}px;left:50%;transform:translateX(-50%);font-size:${size}px;line-height:1;filter:drop-shadow(0 1px 2px rgba(0,0,0,0.8));">🪙</span>`
  ).join('');
